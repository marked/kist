  ...
  <xsl:template match="/">
	...
	<table>
	  <tr>
	    ...
	    <td><a href="NowPlaying.m3u{$Query}">.m3u</a> | <a href="NowPlaying.rss{$Query}">.rss</a> | <a href="NowPlaying.xml{$Query}">.xml</a> | <a href="NowPlaying.txt{$Query}">.txt</a> | <a href="NowPlaying.json{$Query}">.json</a></td>
	  </tr>
	</table>
